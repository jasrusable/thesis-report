	...
	\section{The 3D model}
		...
		\subsection{Level of detail}
			...
			\begin{figure}[h!]
				...
				\caption{Level of detail exaple}
			\end{figure}
			
			In the figure above, a sphere has been modelled at various levels of detail, decreasing from left to right.
			
			\subsubsection{Features}
				How finer features are modelled (conduate, wall plug, door vents)
