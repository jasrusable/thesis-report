	...
	\section{Comparing the photograph to the model}
		...
		\subsection{Comparison results}
			...
			\subsubsection{Photograph adjustments}
				\paragraph{Blurring}
					Bluring was performed using OpenCvs Gaussian blur function. The Gaussian blur function takes two parameters x and y which determine the magnitude of the blur along each x and y axis.
					\begin{figure}[H]
						\centering
