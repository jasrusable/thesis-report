...
\newpage
\chapter{Method}
	There are two main requirements for this alternate indoor positioning method. The first requirement is to have a 3D model of an environment. The second requirement is a photograph of a scene within that environment. The premise is that the photograph could be matched against the 3D model in order to determine where the photograph was taken within that 3D model, thus locating the photographer.
	...
	\section{The 3D model}
		...
		\subsection{3D Interior Model creation}
			...
			\subsubsection{Data acquisition}
				In order to create an accurate 3D model of a building, data is required in order to aid the modeling process and serve as a template or reference. This data can come in the form of building plans, measured distances and directions or point clouds etc.
			...
			\subsubsection{Constructing the model}
				Solid modeling is a consistent set of principles for mathematical and computer modeling of three-dimensional solids which forms the foundation of computer-aided model design. 
				...
				Detail of the model was iteratively increased by modeling finer and finer details.
				...
				The image above shows the model with increased detail. The skirting board, conduate, door as well as white-boards have now been added. All of theses features have been modeled off of the point cloud and so the model is an accurate representation of the actual room in terms of relative scale etc.
