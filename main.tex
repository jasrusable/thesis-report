	...
	\section{The 3D model}
		...
		\subsection{Creating a 3D model}
			...
			\subsubsection{Constructing the model}
				...
				Models are created using various solid representation schemes. The common aim of these solid representation schemes is to organise modelled geometric and topological data in the form of a consistent data structure. A model may be created using any number of combinations of solid representation schemes.
