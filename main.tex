...
\chapter{Introduction}
	...
	\section{Problem statement}
		The objective of this investigation is to determine if it is possible to compare a 3D model to a photograph of a real-world scene within that model.
	...
	\section{Research questions}
		\begin{enumerate}
			...
			\item How does lighting affect the comparison?
			\item How does the texture of modelled objects affect the comparison quality?
			\item How does the quality of model renders affect the comparison?
			\item What is the affect of image enhancements on the comparison?
		\end{enumerate}
	
	\section{Plan of Development}
		This report begins by looking at work related to indoor positioning systems, including existing principles and techniques. Various radio and non-radio indoor positioning technologies are covered in the related work chapter. It appears that there is very little work specifically related to comparing photographs to 3D model.
		
		After the related work chapter, the method of this investigation is detailed. The method contains three sections. The first section deals with the photograph, the second section concerns the 3D interior model and covers how a 3D model is created and modelled and rendered. The last section concerns the comparison of the photograph to the 3D model.
