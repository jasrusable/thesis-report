		...
		\section{Comparison of the model and photograph}
			...
			\subsection{Performing the comparison}
				...
				\subsubsection{Describing key points}
					Once key points have been identified, they need to be described. Feature vectors are created and describe a key point.
					
				\subsubsection{Matching key points}
					Key points need to be matched. Their feature vectors are compared.
