...
\chapter{Method}
	...
	\section{The 3D model}
		...
		\section{Test parameters}
			There are various actions which can be performed on the model, render and photograph which may influence the accuracy of matches, as well as the number of matches obtained during a comparison. These actions and their result on the accuracy of the matches are to be a subject of investigation.
