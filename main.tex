	...
	\section{The 3D model}
		...
		\subsection{Creating a 3D model}
			...
			\subsubsection{Data acquisition}
				...
				It is often the case that the measurements or plans do not accurately reflect the real-world environment in which case the created model may contain inaccuracies. It is for this reason that point clouds are preferable, as point clouds will more accurately represent the real-world environment.
