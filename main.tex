			...
			\subsubsection{Photograph adjustments}
				\paragraph{Blurring}
					...
					\begin{figure}[H]
						...
						\label{fig:x_blur}
					\end{figure}
					Blurring the test image along the x direction 
					\begin{figure}[H]
						\centering
				...
				\paragraph{Edge detection}
					Performing edge detection on the test and query image produced very poor quality matches. Features have been detected but have been poorly matched resulting in an overall poor comparison result.
					\begin{figure}[H]
						\centering
